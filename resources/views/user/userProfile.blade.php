                ...
                <div class="card-body">
                    <form action="{{ route('userProfileUpdate') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="text-center mb-3">
                            <img src="{{ auth()->user()->image ? asset('user/accImages/' . auth()->user()->image) : asset('admin/img/user.jpg') }}"
                                id="profileImagePreview" class="rounded-circle" width="120" height="120"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nickname" class="form-control"
                                value="{{ old('name', auth()->user()->nickname) }}">
                            @error('nickname')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
