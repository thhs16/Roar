          ...
          <div class="container">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-8 ps-lg-5" data-aos="fade-up" data-aos-delay="200">
                <img src="{{ asset('serviceImages/'.$service_detail->image) }}" alt="" class="img-fluid services-img">
                ...
                <ul>
                    <li><i class="bi bi-check-circle"></i> <span>Trained Student : {{ $service_detail->trained_student }}</span></li>
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                                ...
                                                <div class="star-icon">
                                                    ...
                                                    @if ($user_rating )
                                                        ...
                                                        @for ($i=0; $i < $user_rating ; $i++)
                                                            <input type="radio" value="{{$i+1}}" name="serviceRating" id="rating{{$i+1}}" checked>
                                                            <label for="rating{{$i+1}}" class="fa fa-star"></label>
                                                        @endfor

                                                        @for ($i=$user_rating; $i < 5 ; $i++)
                                                            <input type="radio" value="{{$i+1}}" name="serviceRating" id="rating{{$i+1}}">
                                                            <label for="rating{{$i+1}}" class="fa fa-star"></label>
                                                        @endfor
                                                    @else

                                                    <input type="radio" value="1" name="serviceRating" id="rating1" checked>
                                                    <label for="rating1" class="fa fa-star"></label>
                                                    <input type="radio" value="2" name="serviceRating" id="rating2">
                                                    <label for="rating2" class="fa fa-star"></label>
                                                    <input type="radio" value="3" name="serviceRating" id="rating3">
                                                    <label for="rating3" class="fa fa-star"></label>
                                                    <input type="radio" value="4" name="serviceRating" id="rating4">
                                                    <label for="rating4" class="fa fa-star"></label>
                                                    <input type="radio" value="5" name="serviceRating" id="rating5">
                                        ...
                                        <input type="hidden" name="serviceId" value="{{$service_detail->id}}">
                                        <input type="hidden" name="userId" value="{{auth()->user()->id}}">


                                        <textarea name="serviceUserComment" class=" form-control" placeholder="Your Comment"  cols="30" rows="10">@if ($user_comment){{$user_comment->comment}}@endif</textarea>
