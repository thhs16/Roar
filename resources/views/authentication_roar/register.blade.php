            ...
            <div class="container mt-5">
                ...
                <div class="row p-0 m-0">
                    <div class="d-flex shadow-lg rounded-5 p-0">
                        ...
                        <form action="{{ url('register') }}" method="post" class="col-8 offset-2" data-aos="fade-up" data-aos-delay="400">
                            @csrf
                            ...
                            <div class="row gy-4">
                              ...
                              <div class="col-md-6 ">
                                <input type="password" class="form-control @error('confirmPassword') is-invalid @enderror" name="confirmPassword" value="{{old('confirmPassword')}}" placeholder="Confirm Password">
                             ...
                             <div class="col-md-12">
                                <button type="button" class="col-12 btn btn-close-white border-dark">Register with Google <i class="fa-brands fa-google"></i></button>
                             </div>

                             <div class="col-md-12 text-center">
                                <small class="text-muted">Already Registered? <a href="{{ route('login') }}">Login</a></small>
                             </div>
                        ...
                        <div class=" col-lg-6" >
                            <img src="{{asset('img/authImg/a_girl_sitting.jpg')}}" class=" img-fluid rounded-end-5" alt="">
                        </div>
                    </div>
                </div>
