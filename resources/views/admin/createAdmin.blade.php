                    ...
                    <form action="{{ route('createAdminDB') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="mb-3 col-4">
                                ...
                                <input class="form-control @error('image') is-invalid @enderror" name="image" type="file" id="formFile" onchange="loadFile(event)">
                            ...
                            <div class="col-8">
                                ...
                                <div class="form-floating mb-3">
                                    <input name="name" value="{{ old('name') }}" type="text" class="form-control @error('name') is-invalid @enderror" id="floatingText" placeholder="Full Name">
                                ...
                                <div class="form-floating mb-3">
                                    <select name="role" class="form-select @error('role') is-invalid @enderror" id="floatingSelect">
                                ...
                                <div class="form-floating mb-3">
                                    <input name="phone" value="{{ old('phone') }}" type="text" class="form-control @error('phone') is-invalid @enderror" id="floatingPhone" placeholder="Phone Number">
                                ...
                                <div class="form-floating mb-3">
                                    <textarea name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Enter address here" id="floatingTextarea" style="height: 100px;">{{ old('address') }}</textarea>
