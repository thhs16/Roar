                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('serviceDetail', $service_item->id) }}" class="btn btn-info btn-sm">Detail</a>
                                            <a href="{{ route('serviceUpdate', $service_item->id) }}" class="btn btn-warning btn-sm">Update</a>
                                            <a href="{{ route('serviceDelete', $service_item->id) }}" class="btn btn-danger btn-sm">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
